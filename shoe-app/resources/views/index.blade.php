...
.block2-txt-child1 {
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<!-- //link anh -->
				<div class="item-slick1" style="background-image: url({{ asset('images/lll.jpg') }});">
				...
				<div class="item-slick1" style="background-image: url({{ asset('assets/images/banner1.png') }});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<!-- thay địa chỉ ảnh -->
						<img src="{{ asset('images/rrr.png') }}" alt="IMG-BANNER">
						<!-- thay dổi link lấy id của thương hiẹu trong db -->
						<a href="{{ route('product.index') }}?thuonghieu=1" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{ asset('images/lacoste.jpg') }}" alt="IMG-BANNER">

						<a href="{{ route('product.index') }}?thuonghieu=5" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
								LACOSTE
								</span>
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{ asset('images/jordan.jpeg') }}" alt="IMG-BANNER">

						<a href="{{ route('product.index') }}?thuonghieu=6" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									JORDAN
								</span>
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{ asset('images/nike.jpg') }}" alt="IMG-BANNER">

						<a href="{{ route('product.index') }}?thuonghieu=2" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									NIKE
								</span>
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{ asset('images/puma.jpg') }}" alt="IMG-BANNER">

						<a href="{{ route('product.index') }}?thuonghieu=3" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
								PUMA
								</span>
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{ asset('images/dior.jpeg') }}" alt="IMG-BANNER">

						<a href="{{ route('product.index') }}?thuonghieu=4" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									DIOR
								</span>
...
document.addEventListener('DOMContentLoaded', function() {
    const apiUrl = '  http://localhost/shoe-api/public/api';

	fetchCategories();

    function fetchCategories() {
        fetch(`${apiUrl}/danhmuc`)
    ...
    function displayCategories(categories) {
        ...
        categories.forEach(category => {
            ...
            button.textContent = category.ten;
    ...
    function fetchProducts() {
        fetch('  http://localhost/shoe-api/public/api/sanpham')
            .then(response => response.json())
